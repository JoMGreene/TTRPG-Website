const speciesData = [
	{
		"title": "Arbel",
		"colorClasses": "from-[#774422]/90 dark:to-[#000000]/90 to-[#cccccc]/90 border-[#000000]/10",
		"headerClasses": "header-text bg-gradient-to-r from-[#774422]/75 dark:to-[#000000]/90 to-[#ffffff]/25 border-[#000000]/10 max-w-[400px] flex items-center h-[40px] dark:text-shadow-drop",
		"content": ["h1Appearance:", "An Arbel possesses features both feline and arboreal. Notably, their skin color can take on slightly green and brown shades, their eyes are identical to a cat’s, and they have unique patterns of hardened, bark-like skin.", "h1Beliefs:", "Arbel are a people in tune with nature and the magic of the natural world. Many do not support the current research into manatech, citing the ruins of the past civilization as evidence for the consequences of what happens when magic strays too far from its natural state. However, not all Arbel share this philosophy. In Silvitar, the nation founded by Vitarbris’s guardians and homeland to most Arbel, a minority group in support of magitech advancement is beginning to gain traction."],
	},
	{
		"title": "Hanlar",
		"colorClasses": "from-[#774422]/90 dark:to-[#000000]/90 to-[#cccccc]/90 border-[#000000]/10",
