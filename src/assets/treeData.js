const treeData = [
	{
		"title": "World",
		"colorClasses": "from-[#45a2a7]/90 dark:to-[#000000]/90 to-[#ffffff]/90 ",
		"headerClasses": "header-text bg-gradient-to-r from-[#45a2a7]/90 dark:to-[#000000]/90 to-[#ffffff]/25 border-[#000000]/10 max-w-[400px] flex items-center h-[40px] dark:text-shadow-drop",
	...
	},
	{
		...
		"colorClasses": "from-[#45a2a7]/90 dark:to-[#000000]/90 to-[#ffffff]/90 ",
		"headerClasses": "header-text bg-gradient-to-r from-[#45a2a7]/90 dark:to-[#000000]/90 to-[#ffffff]/25 border-[#000000]/10 max-w-[400px] flex items-center h-[40px] dark:text-shadow-drop",
		"content": ["Presence Magic is a tree of magic that focuses primarily on refining one’s own appearance. Whether it be to charm, impress, intimidate, or terrify, presence mages always elicit a strong response from those they interact with. "],
	},
	{
