...
const Magic = () => {
  return (
	<div className='w-full h-auto bg-gradient-to-b from-white to-slate-100 dark:from-primary dark:to-gray-800 flex flex-col justify-center pt-10 items-center font-roboto text-primary dark:text-white pb-10'>
    <div className='w-full flex flex-col justify-center items-center mb-10'>
      ...
      <div className=' w-[90%] h-2 border-t-2 border-slate-400'></div>
		...
		<div className='w-[95%] h-auto bg-primary/10 dark:bg-white/10 flex flex-col rounded-[30px] items-center [border-style:outset] border-2 border-primary/25 dark:border-white/10 font-roboto'>
			<div className='w-full flex flex-col items-center'>
				<h1 className='w-[90%] h-36 md:text-[48px] text-[36px] flex text-left text-shadow-lightTitle dark:text-shadow-drop font-bold p-y-20 items-center'>Magic</h1>
